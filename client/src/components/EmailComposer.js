...
export default function EmailComposer({ parsedData, onSend }) {
  ...
  const [body, setBody] = useState(
    "<p>Dear {Name},</p><p>I am reaching out regarding opportunities at {Company} for the {Role} position.</p><p>{CustomMessage}</p><p>Please find my resume attached.</p>",
  );
  ...
  const isExcelConfigured =
    parsedData.validEmails.length > 0 &&
    parsedData.validEmails[0].subject !== undefined;
          ...
          <div className="card">
            ...
            {isExcelConfigured ? (
              ...
              >
                ...
                >
                  Templates Loaded from Excel
                </h3>
                <p className="label">
                  Each recipient will receive their dynamically mapped Subject
              ...
              <>
                ...
                >
                  ...
                  >
                    Upload your resume (PDF) to dynamically generate a highly
                    professional and tailored email draft based on your profile.
                  </p>
                  <div
                    style={{
                      display: "flex",
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            fontWeight: 600,
                            animation:
                              "generatePulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite",
                          }}
                        >
            ...
            {includeFooter ? (
              <>
                <p className="label" style={{ marginBottom: "1rem" }}>
                  Leave fields blank to automatically exclude them from the
                  email.
                </p>
                <div
                  style={{
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      className="input"
                      value={footer.designation}
                      onChange={(e) =>
                        setFooter({ ...footer, designation: e.target.value })
                      }
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFooter({ ...footer, contact: e.target.value })
                      }
                    />
                  </div>
                </div>
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      setFooter({ ...footer, disclaimer: e.target.checked })
                    }
                  />
                  <label
                    htmlFor="disclaimer"
        ...
        <div>
          ...
          >
            ...
            >
              ...
              >
                Live Preview{" "}
                {isExcelConfigured && `(${previewIndex + 1}/${maxPreviews})`}
              </h3>
              {isExcelConfigured && (
            ...
            >
              ...
              >
                ...
                <p style={{ fontSize: "0.9rem", color: "#666" }}>
                  <strong>From:</strong> {footer.name} &lt;auth@email.com&gt;
                </p>
                <p
                  style={{
                    fontSize: "1.1rem",
