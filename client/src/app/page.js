...
export default function Home() {
  ...
  const handleSend = async (campaignPayload) => {
    ...
    formData.append(
      "senderDetails",
      JSON.stringify(campaignPayload.senderDetails),
    );
  ...
  return (
    <main style={{ minHeight: "100vh", paddingBottom: "4rem" }}>
      ...
      <div className="container" style={{ marginTop: "3rem" }}>
        ...
        {step === 2 && (
          <EmailComposer parsedData={parsedData} onSend={handleSend} />
        )}
        {step === 3 && (
          <StatusDashboard campaignId={campaignId} onReset={handleReset} />
        )}
      </div>
    </main>
  );
